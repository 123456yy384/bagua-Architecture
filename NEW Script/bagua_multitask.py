...
def plot_results(all_results):
    ...
    print("\nResults saved: bagua_multitask_results.png")
    plt.show()
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print("  BaGua Architecture Multi-Task Evaluation Complete")
    for r in all_results:
        winner = 'BaGua' if r['bagua_final'] > r['bert_final'] else 'BERT-like'
        print(f"  {r['task']} ({r['scale']}): BaGua {r['bagua_final']*100:.2f}% | BERT {r['bert_final']*100:.2f}% | Winner: {winner}")
    print("="*60)
